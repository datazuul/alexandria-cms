...
public class XMLAuthor extends XMLObject {
  ...
  public Article getArticle() {
    ...
    if (id != null) {
      result = new ArticleImpl(Long.parseLong(id));
    }
    return result;
  }
  ...
  public Image getImage() {
    ...
    if (id != null) {
      result = new ImageImpl(Long.parseLong(id));
    }
    return result;
  }
