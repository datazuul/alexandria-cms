...
import de.alexandria.cms.backend.impl.file.xml.model.XMLImage;
...
import de.alexandria.cms.model.impl.content.ImagePropertiesImpl;
...
public class ImageRepositoryImpl implements ImageRepository {
  ...
  private ImageProperties saveImageScaled(final BufferedImage image, final int maxWidth, final int maxHeight,
    ...
    return new ImagePropertiesImpl(targetWidth, targetHeight, file.getName());
  }
