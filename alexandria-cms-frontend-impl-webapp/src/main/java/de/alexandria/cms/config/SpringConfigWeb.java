...
import de.alexandria.cms.frontend.webapp.converter.GrantedAuthorityJsonFilter;
import de.alexandria.cms.frontend.webapp.converter.UserJsonFilter;
import de.alexandria.cms.frontend.webapp.interceptors.CreateAdminUserInterceptor;
...
@ComponentScan(basePackages = {
    "de.alexandria.cms.frontend.webapp.aop",
    "de.alexandria.cms.frontend.webapp.controller",
    "de.alexandria.cms.frontend.webapp.propertyeditor"
})
@EnableAspectJAutoProxy
@EnableWebMvc
@PropertySource(value = {
    "classpath:de/alexandria/cms/config/SpringConfigWeb-${spring.profiles.active:local}.properties"
})
public class SpringConfigWeb extends WebMvcConfigurerAdapter {
    ...
    public ClassLoaderTemplateResolver classLoaderTemplateResolver() {
        ...
        templateResolver.setPrefix("/de/alexandria/cms/frontend/webapp/thymeleaf/templates/");
